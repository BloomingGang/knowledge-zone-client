        ...
        <div key={index} className="instructor">
          ...
          <div className="socialIcon text-2xl sm:text-center">
            ...
            <a href="" target={"_blank"} rel="noreferrer">
              {" "}
              <i id="fb" class="icon fa-brands fa-facebook-f"></i>
            </a>
            <a href="" target={"_blank"} rel="noreferrer">
              {" "}
          ...
          <div className="text-center">
            <h2 className="text-primary text-center text-2xl font-bold pt-4">
              {instructor.name}
            </h2>
            <p className="text-lg font-medium">{instructor.education}</p>
          </div>
        </div>
      ))}
    </div>
