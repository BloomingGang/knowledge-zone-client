...
const CourseDetailsCart = () => {
    const freeCourse =
    {
        ...
        "state": "unread",
        "ShortDescription": "Learn both written and spoken English for getting ahead in professional spheres. An all inclusive course of effective English communication for professionals.",
        "instructorImg": "https://i.ibb.co/By9KmF7/free-Course.png",
        "instructorName": "Munzereen Shahid",
        "education": "MS (English), University of Oxford (UK); BA, MA (English), University of Dhaka; IELTS: 8.5",
        "objective": {
    ...
    const { title, img, ShortDescription, objective, instructorImg, instructorName, education, about, syllabus, price, Enrolled, hours, videos, quizzes, notes, transcripts } = freeCourse;
    ...
    return (
        <div className='container mx-auto grid lg:grid-cols-2 grid-cols-1 gap-12 py-12'>
            <div>
                ...
                <div>
                    <h1 className='text-2xl text-violet-700 mb-4'>What you will learn from this course</h1>
                    <div className='border-2 rounded-xl'>
                        <div className='p-6'>
                            <p><i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i>{objective.point1}</p>
                            <p><i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i> {objective.point2}</p>
                            <p> <i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i>{objective.point3}</p>
                        </div>

                        <hr />

                        <div className='p-6'>
                            <h1 className='text-xl text-violet-700 mb-4'>About This Course</h1>
                            <p>{about}</p>
                        </div>
                    </div>
                </div>
            ...
            <div className='border-2 rounded-xl'>
                ...
                <div className='p-8'>
                    <div className='flex justify-between'>
                        <a className='text-indigo-700' href="#"><u>Promo Code</u></a>
                    ...
                    <div className='flex justify-between py-6'>
                        <div>
                            <p><i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i> {videos} Videos</p>
                            <p><i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i> {notes} Notes</p>
                        </div>
                        <div>
                            <p><i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i> {quizzes} Sets of Quizzes</p>
                            <p><i class="text-indigo-900 mr-4 font-bold text-xl fa-solid fa-angles-right"></i> {transcripts} Transcripts</p>
                        </div>
                    </div>
