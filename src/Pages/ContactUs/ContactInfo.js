  ...
  return (
    ...
    <div className="w-10/12 md:w-11/12 mx-auto grid md:grid-cols-3 gap-3">
      <div className="text-xl flex items-center">
        <i class="bg-violet-800 rounded-xl p-3 mr-4 text-2xl text-white fa-solid fa-phone"></i>
        <div>
          <p>
      ...
      <div className="text-xl flex items-center">
        <i class="bg-violet-800 rounded-xl p-3  text-2xl text-white mr-4 fa-solid fa-location-dot"></i>
        <div>
          <p>
      ...
      <div className="text-xl flex items-center">
        <i class="bg-violet-800 rounded-xl p-3 mr-4 text-2xl text-white fa-solid fa-envelope"></i>
        <div>
          <p>
