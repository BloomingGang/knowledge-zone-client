...
const LearningProgram = () => {
    return (
        <section className='text-3xl overflow-x-hidden mt-20 container mx-auto'>
           ...
           <div className='container bg-blue-400 mb-10 text-center flex  justify-between mt-10 sm:mx-5 lg:w-1/2 w-full whitespace-nowrap mx-auto py-5 px-10 rounded-full  text-xs md:text-2xl lg:text-3xl' >
