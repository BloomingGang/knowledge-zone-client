      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 py-16 px-6 md:px-0">
          <div className="bg-gray-100 rounded-xl p-5">
            ...
            <img src={img1} alt="" className="rounded-lg pb-5 h-[250px] w-96 mx-auto" />
          ...
          <div className="bg-gray-100 rounded-xl p-5">
            ...
            <img src={img2} alt="" className="rounded-lg pb-5 h-[250px] w-96 mx-auto" />
            <p className="text-lg text-justify">
          ...
          <div className="bg-gray-100 rounded-xl p-5">
            ...
            <img src={img3} alt="" className="rounded-lg pb-5 h-[250px] w-96 mx-auto" />
            <p className="text-lg text-justify">
