...
import hoverImg from "../../img/assets/10008.jpg";
        ...
        <div className="bg-blue-100 border-2 rounded-3xl">
          <div className=" lg:flex static px-[10%]">
            <div className="lg:w-[50%] w-full flex justify-around flex-col sm:order-2 lg:order-1 gap-y-3 lg:gap-y-0 mt-5 lg:mt-0">
              ...
              <h2 className=" text-2xl lg:text-3xl text-indigo-700 font-bold">
                Play-Based Learning
              </h2>
              <p className="text-xl">
            ...
            <div className="lg:w-[50%] w-full flex justify-center sm:order-1 lg:order-2">
              <img className="py-10 w-full text-center" src={hoverImg} alt="" />
            </div>
          </div>
        </div>
      </div>
