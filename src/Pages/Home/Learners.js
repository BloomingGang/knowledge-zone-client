...
const Learners = () => {
  return (
    <div className="w-10/12 mx-auto shadow-xl py-6 mt-[-50px] bg-white rounded-xl">
      <h1 className="text-center md:text-5xl mb-10">
      ...
      <div className="flex justify-evenly mb-4">
        ...
        <div>
          ...
          <p className="font-bold text-center">100% safe for <br /> kids</p>
        </div>
      </div>
    </div>
  );
